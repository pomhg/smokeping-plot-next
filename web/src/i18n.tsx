...
const dict = {
  en: {
    ...
    densityRow: 'List',
    stUp: 'OK',
    stDegraded: 'Packet loss',
    stDown: 'Down',
    stStale: 'No data',
    stPaused: 'Paused',
    problemsN: '{n} need attention',
    allGood: 'All targets OK',
    showProblems: 'Show only these',
    showAll: 'Show all',
    clearFilters: 'Clear filters',
    sortPaused: 'Dragging is disabled while a filter is active.',
    downFor: 'DOWN {t}',
    neverUp: 'NEVER UP',
    staleFor: 'NO DATA {t}',
    staleHint: 'No probe result has been recorded recently. Is the service running?',
    current: 'Now',
    status: 'Status',
    jitter: 'Jitter',
    jitterHint: 'Average spread between the 25th and 75th percentile of each round',
    lastOk: 'last reply {t}',
    rangeAvg: 'Median avg',
    prevTarget: 'Previous target',
    nextTarget: 'Next target',
    shortcuts: '← → switch target',
  },
  zh: {
    appName: 'smokeping-plot-next',
    overview: '总览',
    ...
    showAll: '显示全部',
    clearFilters: '清除筛选',
    sortPaused: '筛选状态下暂停拖拽排序。',
    downFor: '中断 {t}',
    neverUp: '从未连通',
    staleFor: '无数据 {t}',
    staleHint: '最近没有新的探测结果，服务是否在运行？',
    current: '当前',
    status: '状态',
    jitter: '抖动',
    jitterHint: '每轮 25%–75% 分位的平均间距',
    lastOk: '最后应答 {t}',
    rangeAvg: '中位数均值',
    prevTarget: '上一个节点',
    nextTarget: '下一个节点',
